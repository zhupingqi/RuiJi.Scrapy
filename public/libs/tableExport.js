        ...
        loadImages(teOptions, function () {
          $(el).filter(function () {
            ...
            // Fix jsPDF Autotable's row height calculation
              if (typeof atOptions.addPageContent !== 'function' ) {
                  atOptions.addPageContent = function (data) {
                if ( data.pageCount === 1 ) {
                ...
                if ( typeof teOptions.columns [data.column.dataKey] !== 'undefined' ) {
                  ...
                  if ( typeof col.rect !== 'undefined' ) {
                    ...
                    if ( typeof teOptions.heightRatio === 'undefined' || teOptions.heightRatio === 0 ) {
                      ...
                      teOptions.heightRatio = cell.styles.vertical / rh;
                    }

                    rh = data.row.raw [data.column.dataKey].rect.height * teOptions.heightRatio;
                    if ( rh > cell.styles.vertical )
                      cell.styles.vertical = rh;
                  }
              ...
              while ( lastrow >= 0 ) {
                $.each(teOptions.headerrows[lastrow], function () {
                  ...
                  if ( lastrow > 0 && this.rect === null )
                    obj = teOptions.headerrows[lastrow - 1][this.dataKey];
